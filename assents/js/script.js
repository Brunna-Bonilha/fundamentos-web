...
por Tag: getElementeByTagName() - se colocar # dentro dos () não vai funcionar
por Id: getElementeById()
por Nome: getElementByName()
por Classe: getElementsByClassName()
por Seletor: querySelector(#) - melhor pratica para acessar o DOM, não esquecer de colocar #
*/
